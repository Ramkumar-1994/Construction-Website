    ...
    <>
      ...
      <motion.div
        ...
        variants={slideUpVariants}className='lg:w-[80%] w-[90%] m-auto py-[60px] flex flex-col justify-between items-center gap-[20px]'>
          ...
          <motion.h1
          variants={slideUpVariants} className='text-[40px] font-bold uppercase text-white text-center'>
            our Best Projects
          </motion.h1>
          <motion.div
        ...
        <motion.div
          ...
          className='w-full m-auto grid lg:grid-cols-4 grid-cols-1 px-10 lg:px-0'>
